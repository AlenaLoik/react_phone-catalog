...
const getProduct = (): Promise<IProduct[]> => {
...
export const PhoneCatalog: React.FC<Props> = ({ history, location }) => {
  ...
  return (
    <div className="phones-page">
      ...
      <h1 className="phones-page__title">Mobile phones Page {page}, perPage: {perPage}</h1>
  <p className="phones-page__counter">{visiblePhones.length}{" "} models</p>
      <ProductList phoneName={phoneName} phones={visiblePhones} />
    </div>
  );
};
